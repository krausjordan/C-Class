...
// Shuffles cards in deck randomly
int Deck::shuffle(){                                      
...
//Takes "top" card off deck and returns it. Removes this card from deck
Card Deck::drawCard(){
...
//Makes normal 52 card deck. Face cards are worth 10, Aces 11
int Deck::make52CardDeck(){
    ...
    for(int i=0;i<4;i++){
        deck.push_back(Card(11,Suit(i),false,false,true,"Jack"));
        deck.push_back(Card(12,Suit(i),false,false,true,"Queen"));
        deck.push_back(Card(13,Suit(i),false,false,true,"King"));
