...
//Arg constructor
Ship::Ship(unsigned int priority, unsigned int number, string newName, DateTime newDateTime){
    this->name=newName;
...
std::ostream& operator<<(std::ostream& os, const Ship& ship){
    ...
    os<<"Priority: "<<ship.cargoPriority<<"  Arrival Time: "<<ship.datetime<< "  Name: "<<ship.name<<"   ID: "<<ship.shipNumber;
    return os;
}

// Returns object's datetime
DateTime Ship::getDateTime(){
